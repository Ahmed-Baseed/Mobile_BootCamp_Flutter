...
import 'package:mobile_bootcamp_flutter/api_mokhtar_part2/core/controllers/user_controller.dart';
...
class _UsersScreenState extends State<UsersScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: FutureBuilder(
        future: uController.loadUsers(OnlineDataRepo(), APIRoutes.USERS_PAGE),
